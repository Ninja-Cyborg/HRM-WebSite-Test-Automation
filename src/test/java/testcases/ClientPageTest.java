...
public class ClientPageTest extends BaseClass{
	...
	@Test(groups="Smoke")
	public void verifyWebsiteLinks() throws IOException, InterruptedException {
		...
		boolean result = clientPage.areLinksBroken();
		String message = clientPage.brokenLinkMessage(); 
